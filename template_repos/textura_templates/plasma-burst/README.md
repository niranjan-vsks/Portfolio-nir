...
This bundle is the complete source for the **Plasma Burst** 3D scene: a single self-contained
`plasma-burst.html` file plus every asset it needs (in `assets/`). It's built with Three.js and
...
```sh
npx serve .          # then open the printed URL and click plasma-burst.html
