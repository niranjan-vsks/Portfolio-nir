...
This bundle is the complete source for the **Solaris** 3D scene: a single self-contained
`solaris.html` file plus every asset it needs (in `assets/`). It's built with Three.js and
...
```sh
npx serve .          # then open the printed URL and click solaris.html
