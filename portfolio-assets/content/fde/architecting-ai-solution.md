...
- Chose structured event sourcing over vector RAG for Loop Copilot's memory, which removed hallucinated recall while keeping cross-session context: architecture decisions driven by failure modes, not fashion.
