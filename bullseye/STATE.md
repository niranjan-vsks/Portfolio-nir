...
### R2 — Background effects library · HARD (split if needed)
...
### R3 — Shared card systems · HARD (split: R3a/R3b/R3c)
...
### R4 — Home rebuild (Ascend hub) · HARD
...
### R5 — Mind Map renovation · HARD (pre-authorized fallback)
...
### R6 — Project pages renovation · HARD
