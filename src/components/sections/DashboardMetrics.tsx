...
/**
 * Dashboard metrics (PRD 6.8). Every number traces to real content (cited in
...
const METRICS: Metric[] = [
  ...
  { value: "3", label: "independent products", sub: "Loop Copilot · Saarthi · Rebalancer", href: "/projects" },
