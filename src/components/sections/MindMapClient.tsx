...
/**
 * Mind Map . Brain particle intro hands off to the react-force-graph
 ...
 *
 * UX: the brain intro plays only on the FIRST /map visit of the
      ...
      {phase === "graph" && (
        <div className="absolute inset-0 animate-[fadeIn_0.8s_ease]">
          {/* intense starfield ONLY behind the transparent graph — the plume
              was rejected too : keep space, no effects */}
