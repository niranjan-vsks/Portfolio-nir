...
// Optional, noindex . Main profile stays FDE-pure; this is a
    ...
    <PageShell eyebrow="work_with_me" title="Work with me">
      <div className="max-w-2xl space-y-6 text-text">
        ...
        <p className="text-text-dim">
          ...
          understand the problem fast, and ship production-grade systems that
          integrate seamlessly. Remote-first, available to work with teams globally.
        </p>
